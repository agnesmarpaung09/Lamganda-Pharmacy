...
@section('content')
    ...
    <div class="container col-4">
        <div class="d-flex justify-content-between align-items-center">
            <div class="title">
                @if(auth()->user()->role == 'karyawan' || auth()->user()->role == 'admin')
                    <a href="/dashboard/profile" class="btn btn-outline-danger"> <- Kembali</a>
                @else
                    <a href="/profile" class="btn btn-outline-danger"> <- Kembali</a>
                @endif
                <h1 class="title-text mt-3">Edit Profil asd</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="/profile/update/{{ $user['id'] }}">
                    <div class="mb-3">
