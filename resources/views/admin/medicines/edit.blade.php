...
<div class="container">
    ...
    <form method="POST" action="/dashboard/medicine-management/update/{{ $medicine->id }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="code" id="code" value="{{ $medicine->code }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="stock" class="form-control" id="stock" value="{{ $medicine->stock }}">
                    </div>
                    <div class="mb-3">
                        <label for="image" class="form-label">Image</label>
                        <input type="file" name="image" class="form-control" id="image">
                        <img class="mt-3" src="{{ $medicine->image }}" width="200px">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="expired_date" class="form-control" id="expired_date" value="{{ date('Y-m-d', strtotime($medicine->expired_date)) }}">
                </div>
                <div class="mb-3">
                    <label for="description" class="form-label">Deskripsi</label>
                    <textarea style="height: 200px" type="text" name="description" class="form-control" id="description" value="{{ $medicine->description }}">{{ $medicine->description }}</textarea>
                </div>
            </div>
        </div>
        <div class="row mt-2">
