    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <div class="title">
                ...
                <p class="title-desc mt-1">Manajemen User Apotek Lamganda</p>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <form action="/dashboard/user-management/search" method="GET">
                    <div class="input-group mb-3 mt-2">
                        <input class="i-search" type="text" name="keyword" placeholder="Cari nama user" value="{{ request()->input('keyword') }}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="#"onclick="showConfirmation('/dashboard/user-management/delete/{{ $user['id'] }}')"><button class="btn btn-danger">Delete</button></a>
