...
@section('content')
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <div class="title">
                <a href="/order" class="btn btn-outline-danger mb-3"> <- Kembali</a>
            ...
            <div>
                ...
                @elseif($orders[0]['order']['status'] == 'Berhasil')
                    <td class="align-middle text-center"><button disabled class="btn btn-outline-primary">Disetujui Admin</button></td>
                @else
