            ...
            <div class="collapse navbar-collapse" id="navbarText">
                @if (Route::has('login'))
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('order-management') ? 'active' : ''}} "  aria-current="page" href="{{ url('/dashboard/order-management') }}">MANAJEMEN PESANAN</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('order-history') ? 'active' : ''}}" href="/dashboard/order-history">RIWAYAT PENJUALAN</a>
                        </li>
                        @if ( auth()->user()->role == 'admin')
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('medicine-management') ? 'active' : ''}}" href="/dashboard/medicine-management">MANAJEMEN OBAT</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('user-management') ? 'active' : ''}}" href="/dashboard/user-management">MANAJEMEN USER</a>
                            </li>
                        @endif
