    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <div class="title">
                ...
                <p class="title-desc mt-1">Status Pesanan di Apotek Lamganda</p>
            </div>
        </div>
                ...
                <table class="table table-bordered mt-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @elseif($order['status'] == 'Ditolak Admin' || $order['status'] == 'Ditolak Karyawan')
                            ...
                            @if($order['status'] == 'Checking Admin')
                                <td class="text-center">
                                    ...
                                    <a href="#" onclick="showConfirmation('order/reject/{{ $order['id'] }}')"><button class="btn btn-danger">Batalkan</button></a>
                                    <a href="/status/{{ $order['id'] }}"><button class="btn btn-primary">Lihat Detail</button></a>
                                </td>
                            @else
                                <td class="text-center">
                                    <a href="/status/{{ $order['id'] }}"><button class="btn btn-primary">Lihat Detail</button></a>
